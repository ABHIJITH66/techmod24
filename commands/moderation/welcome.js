      ...
      if (args[1] === "unset") {
        ...
        if (!ch) {
          let embed = new discord.MessageEmbed()
              .setColor(Color)
            .setDescription(
              `❌ First use the command welcome channel set #channel\``
            );
          return message.channel.send(embed);
        }
        let embed = new discord.MessageEmbed()
    ...
    if (args[0] === "message") {
      ...
      if (args[1] === "set") {
        ...
        let tex = message.content
          .split(`$welcome message set `)
          .join("");
        if (db_tex) {
          let embed = new discord.MessageEmbed()
              .setColor(Color)
            .setDescription(
              `❌ If u want to change use welcome message edit <message>\` or \`$welcome message unset\``
            );
          return message.channel.send(embed);
        }
        if (!args[2]) {
      ...
      if (args[1] === "unset") {
        ...
        if (!tex) {
          let embed = new discord.MessageEmbed()
              .setColor(Color)
            .setDescription(
              `❌ First use the command \`$welcome message set <message>\``
            );
          return message.channel.send(embed);
        }
        let embed = new discord.MessageEmbed()
      ...
      if (args[1] === "set") {
        ...
        if (db_image) {
          let embed = new discord.MessageEmbed()
           .setColor(Color)
            .setDescription(
              `❌ If u want to disable this pluing use \`$welcome image unset\``
            );
          return message.channel.send(embed);
        }
      ...
      if (args[1] === "unset") {
        ...
        if (!image) {
          let embed = new discord.MessageEmbed()
              .setColor(Color)
            .setDescription(
              `❌ First use the command \`welcome image set\``
            );
          return message.channel.send(embed);
        }
        let embed = new discord.MessageEmbed()
